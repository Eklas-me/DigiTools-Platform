...
const Navbar = ({ cartCount = 0 }) => {
  return (
    <nav className="flex items-center justify-between px-6 py-4 bg-white md:px-12 max-w-7xl mx-auto w-full">
      {/* Logo */}
      ...
      <div className="flex items-center gap-6">
        ...
        <div className="hidden sm:flex items-center gap-4 ml-4">
          ...
          <button className="px-6 py-2.5 text-sm font-semibold text-white bg-[#7A33FF] rounded-full hover:bg-purple-700 transition-colors shadow-md">
            Get Started
          </button>
        </div>
